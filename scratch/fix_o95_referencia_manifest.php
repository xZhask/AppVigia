...
$secId = 2516; // Seccion Referencia (Anexo 1)

// Reconstruir lista exacta de campos del manifiesto desde la BD para la seccion 6 de O95 (Referencia)
...
echo "Manifiesto de Referencia reconstruido desde DB.\n";
