...
$secId = $pdo->query("SELECT id, orden, nombre FROM seccion_def WHERE enfermedad_id = (SELECT id FROM enfermedad WHERE cie10 = 'O95') AND (nombre LIKE '%entorno%' OR orden = 9)")->fetch(PDO::FETCH_ASSOC);
