...
$secId = $pdo->query("SELECT id, orden, nombre FROM seccion_def WHERE enfermedad_id = (SELECT id FROM enfermedad WHERE cie10 = 'O95') AND (nombre LIKE '%demoras%' OR orden = 11)")->fetch(PDO::FETCH_ASSOC);
