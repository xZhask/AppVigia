...
$secLugarInf = &$manifiesto['fichas']['B05']['secciones'][6]; // Lugar probable de infección
echo "Sección en manifiesto: {$secLugarInf['nombre']}\n";

// Consultar los campos de la sección 2777 en BD
$stmt = $pdo->prepare("SELECT * FROM campo_def WHERE seccion_id = 2777 ORDER BY orden ASC");
$stmt->execute();
...
$secLugarInf['campos'] = $nuevosCamposManifest;
