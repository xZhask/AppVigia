...
class CasoLugarInfeccion extends Model
{
     ...
     * ['lugar_institucion','localidad_texto','permanencia_dias','distrito_id'].
    ...
    public static function reemplazarTodos(int $casoId, array $filas): void
    {
        ...
        $consulta = $pdo->prepare(
            'INSERT INTO caso_lugar_infeccion (caso_id, lugar_institucion, localidad_texto, permanencia_dias, distrito_id, direccion)
             VALUES (:caso, :lugar_institucion, :localidad_texto, :permanencia_dias, :distrito_id, :direccion)'
        );
