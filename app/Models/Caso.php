...
class Caso extends Model
{
    ...
    public static function conDetalle(int $id): ?array
    {
        $sql = 'SELECT c.*, p.tipo_doc, p.num_doc, p.apellido_paterno, p.apellido_materno, p.nombres, p.sexo, p.fecha_nac,
                       ...
                       p.celular, p.nacionalidad, p.direccion, p.referencia_localizar, p.localidad, p.etnia, p.etnia_otra, p.pueblo_etnico, p.nombre_tutor, p.celular_tutor, p.gestante, p.semanas_gestacion, p.trimestre_gestacion,
