...
class CasoSujeto
{
     ...
     * y el valor es un array con los datos del sujeto.
     */
    public static function guardarSujetos(int $casoId, array $sujetos): void
    {
        ...
        $stmtInsert = $db->prepare(
            'INSERT INTO caso_sujeto (caso_id, persona_id, rol, apellidos, nombres, doc, sexo, edad)
             VALUES (:caso, :persona, :rol, :apellidos, :nombres, :doc, :sexo, :edad)'
        );
