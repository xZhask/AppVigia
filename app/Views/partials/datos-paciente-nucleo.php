...
<?php endif; ?>
<!-- 1/3. Celular + Etnia / raza + Pueblo étnico o etnia + Ocupación (misma
     fila -- Celular se une acá, no en su propia fila, para no dejar una
     fila de 3 columnas con un solo campo; pedido del usuario, cotejo B04X
     2026-08-29). Nacionalidad/Localidad/Domicilio actual/Referencia para
     localizar/Tiempo de residencia/Tipo de localidad (B05) viven en
     datos-paciente-nucleo-residencia.php -- pedido del usuario (cotejo B04X,
     2026-08-29): agrupar los datos genuinamente personales antes que los de
     residencia, en vez de intercalarlos. El shell (nueva/index.php,
     fichas/editar.php) requiere ese partial DESPUÉS del selector de
     Departamento/Provincia/Distrito ("Residencia habitual"), así el bloque
     de residencia queda junto y en un solo lugar. -->
<div class="fields thirds" style="margin-top:14px">
  ...
  <?php
  // nucleo_condicional (cotejo Z21, 2026-09-11): Etnia solo la pide una de
