...
<form method="post" action="/casos/nuevo">
  ...
  <div class="grid form-grid">
    <div>
      ...
      <!-- 5. Laboratorio -->
      <?php
      // A95 (cotejo 2026-08-23): "Laboratorio" (caso_muestra, "+ Agregar
      // muestra") ya se inyecta dentro de la sección campo_def "Laboratorio"
      // (secciones-clinicas.php, justo después de "Datos del laboratorio")
      // -- mostrar TAMBIÉN esta tarjeta genérica al final del formulario
